...
logowl " " "SPACE"
logowl "Even though $MOD_NAME will uninstall SafetyCore and KeyVerifier" "SPACE"
logowl "and reinstall placeholder APPs again automatically as system booting" "SPACE"
logowl "If you DO NOT want these APPs to come back" "SPACE"
